...
const ages = [22, 14, 24, 55, 65, 21, 12, 13, 90];*/
const isPar = ages.filter(number => number % 2 == 0)
console.log(isPar)
...
const infoStreamers = streamers.filter(streamer => {
   let includeLegends = streamer.gameMorePlayed.includes('Legends') 
    if (includeLegends && streamer.age > 35){
